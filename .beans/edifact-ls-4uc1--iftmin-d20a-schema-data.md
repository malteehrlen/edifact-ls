...
[ ] IFTMIN's real branching diagram transcribed accurately (position,
tag, mandatory/conditional, max repeat, nesting) from the cited
source, verified to balance before transcription
[ ] Registered for the exact tuple (IFTMIN, D, 20A, UN)
[ ] Unit tests: a conformant IFTMIN message passes with no structural
...
[ ] e2e check: opening a fixture with a structural IFTMIN violation
