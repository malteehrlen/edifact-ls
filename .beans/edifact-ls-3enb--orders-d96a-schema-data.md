---
# edifact-ls-3enb
title: ORDERS D.96A schema data
status: todo
type: feature
priority: normal
...
Transcribe ORDERS's (Purchase Order) real D.96A branching diagram into
SchemaNode data and register it alongside the existing D.20A schema
for (Type: "ORDERS", Version: "D", Release: "96A", Agency: "UN"),
