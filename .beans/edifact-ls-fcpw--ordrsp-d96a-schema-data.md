---
# edifact-ls-fcpw
title: ORDRSP D.99B schema data
status: completed
type: feature
priority: normal
...
Transcribe ORDRSP's (Purchase Order Response) real D.99B branching diagram into
SchemaNode data and register it alongside the existing D.20A schema,
for (Type: "ORDRSP", Version: "D", Release: "99B", Agency: "UN"), using
...
internal/edifact/ordrsp_d99b.go: 56 segment groups, max depth 3. Same
shape as D.20A's ORDRSP: BGM, DTM, and UNS all mandatory at the top
level.

internal/edifact/ordrsp_d99b_test.go: registered, minimal conformant
pass, missing mandatory DTM, and BGM exceeding its cap of 1.

testdata/ordrsp-d99b-violation.edi + scripts/e2e_check.lua: e2e check
