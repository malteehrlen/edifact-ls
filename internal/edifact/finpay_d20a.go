...
// FINPAY D.20A message specification: the structural (segment/group
// presence, order, cardinality) branching diagram for this message,
// UN/EDIFACT directory release D.20A. Scope is structural only -- not
// element-level content -- per edifact-ls-3uzr's epic non-goal.
// 32 segment groups, max nesting depth 6.
//
// Source: https://service.unece.org/trade/untdid/d20a/trmd/finpay_c.htm
// section 4.3.1 "Segment table". That URL currently returns HTTP 403 from
// Cloudflare when fetched directly; this data was transcribed from the
// Wayback Machine's archived copy instead:
// http://web.archive.org/web/20230608013520/https://service.unece.org/trade/untdid/d20a/trmd/finpay_c.htm
...
// balances (all 32 groups open and close consistently)
...
func init() {
	RegisterSchema(
		MessageID{Type: "FINPAY", Version: "D", Release: "20A", Agency: "UN"},
		finpayD20aSchema,
		"https://service.unece.org/trade/untdid/d20a/trmd/finpay_c.htm",
	)
}

var finpayD20aSchema = Schema{Nodes: []SchemaNode{
		...
		Group: []SchemaNode{
			...
			{ // Segment group 12
				Group: []SchemaNode{
					...
					{Segment: "BUS", Mandatory: false, MaxRepeat: 1}, // Business function
					{Segment: "DTM", Mandatory: false, MaxRepeat: 6}, // Date/time/period
					{ // Segment group 13
						Group: []SchemaNode{
							{Segment: "FII", Mandatory: true, MaxRepeat: 1},  // Financial institution information
							{Segment: "CTA", Mandatory: false, MaxRepeat: 1}, // Contact information
