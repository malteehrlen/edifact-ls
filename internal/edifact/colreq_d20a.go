...
// COLREQ D.20A message specification: the structural (segment/group
// presence, order, cardinality) branching diagram for this message,
// UN/EDIFACT directory release D.20A. Scope is structural only -- not
// element-level content -- per edifact-ls-3uzr's epic non-goal.
// 7 segment groups, max nesting depth 1.
//
// Source: https://service.unece.org/trade/untdid/d20a/trmd/colreq_c.htm
// section 4.3.1 "Segment table". That URL currently returns HTTP 403 from
// Cloudflare when fetched directly; this data was transcribed from the
// Wayback Machine's archived copy instead:
// http://web.archive.org/web/20230608030528/https://service.unece.org/trade/untdid/d20a/trmd/colreq_c.htm
...
func init() {
	RegisterSchema(
		MessageID{Type: "COLREQ", Version: "D", Release: "20A", Agency: "UN"},
		colreqD20aSchema,
		"https://service.unece.org/trade/untdid/d20a/trmd/colreq_c.htm",
	)
}

var colreqD20aSchema = Schema{Nodes: []SchemaNode{
	{Segment: "BGM", Mandatory: true, MaxRepeat: 1},   // Beginning of message
	{Segment: "DTM", Mandatory: false, MaxRepeat: 1},  // Date/time/period
	{Segment: "FCA", Mandatory: true, MaxRepeat: 1},   // Financial charges allocation
	{Segment: "DOC", Mandatory: true, MaxRepeat: 40},  // Document/message details
	{Segment: "INP", Mandatory: false, MaxRepeat: 20}, // Parties and instruction
	{Segment: "FTX", Mandatory: false, MaxRepeat: 15}, // Free text
	{ // Segment group 1
		Group: []SchemaNode{
		...
		Mandatory: true, MaxRepeat: 7,
	},
	{ // Segment group 2
		Group: []SchemaNode{
			{Segment: "NAD", Mandatory: true, MaxRepeat: 1},  // Name and address
			{Segment: "RFF", Mandatory: false, MaxRepeat: 3}, // Reference
			{Segment: "CTA", Mandatory: false, MaxRepeat: 1}, // Contact information
			{Segment: "COM", Mandatory: false, MaxRepeat: 5}, // Communication contact
		},
