...
// RESMSG D.20A message specification: the structural (segment/group
// presence, order, cardinality) branching diagram for this message,
// UN/EDIFACT directory release D.20A. Scope is structural only -- not
// element-level content -- per edifact-ls-3uzr's epic non-goal.
// 14 segment groups, max nesting depth 4.
//
// Source: https://service.unece.org/trade/untdid/d20a/trmd/resmsg_c.htm
// section 4.3.1 "Segment table". That URL currently returns HTTP 403 from
// Cloudflare when fetched directly; this data was transcribed from the
// Wayback Machine's archived copy instead:
// http://web.archive.org/web/20240421091045/https://service.unece.org/trade/untdid/d20a/trmd/resmsg_c.htm
...
func init() {
	RegisterSchema(
		MessageID{Type: "RESMSG", Version: "D", Release: "20A", Agency: "UN"},
		resmsgD20aSchema,
		"https://service.unece.org/trade/untdid/d20a/trmd/resmsg_c.htm",
	)
}

var resmsgD20aSchema = Schema{Nodes: []SchemaNode{
	...
	{Segment: "PYT", Mandatory: false, MaxRepeat: 10}, // Payment terms
		...
		Group: []SchemaNode{
			...
			{ // Segment group 5
				Group: []SchemaNode{
					...
					{Segment: "PCD", Mandatory: false, MaxRepeat: 1},  // Percentage details
					{Segment: "PAI", Mandatory: false, MaxRepeat: 1},  // Payment instructions
					{Segment: "PYT", Mandatory: false, MaxRepeat: 5},  // Payment terms
					{Segment: "FII", Mandatory: false, MaxRepeat: 5},  // Financial institution information
