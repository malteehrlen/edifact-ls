...
// PARTIN D.20A message specification: the structural (segment/group
// presence, order, cardinality) branching diagram for this message,
// UN/EDIFACT directory release D.20A. Scope is structural only -- not
// element-level content -- per edifact-ls-3uzr's epic non-goal.
// 15 segment groups, max nesting depth 4.
//
// Source: https://service.unece.org/trade/untdid/d20a/trmd/partin_c.htm
// section 4.3.1 "Segment table". That URL currently returns HTTP 403 from
// Cloudflare when fetched directly; this data was transcribed from the
// Wayback Machine's archived copy instead:
// http://web.archive.org/web/20231202090713/https://service.unece.org/trade/untdid/d20a/trmd/partin_c.htm
...
func init() {
	RegisterSchema(
		MessageID{Type: "PARTIN", Version: "D", Release: "20A", Agency: "UN"},
		partinD20aSchema,
		"https://service.unece.org/trade/untdid/d20a/trmd/partin_c.htm",
	)
}

var partinD20aSchema = Schema{Nodes: []SchemaNode{
	{Segment: "BGM", Mandatory: true, MaxRepeat: 1},   // Beginning of message
	{Segment: "DTM", Mandatory: true, MaxRepeat: 5},   // Date/time/period
	{Segment: "FII", Mandatory: false, MaxRepeat: 10}, // Financial institution information
		...
		Group: []SchemaNode{
			...
			{ // Segment group 10
				Group: []SchemaNode{
					...
					{Segment: "CUX", Mandatory: false, MaxRepeat: 2}, // Currencies
