...
// ORDERS D.99B message specification: the structural (segment/group
// presence, order, cardinality) branching diagram for the Purchase Order
...
// (see orders_d20a.go). D.99B was chosen as a second, older release
...
// http://web.archive.org/web/20211024113516/https://service.unece.org/trade/untdid/d99b/trmd/orders_c.htm
...
func init() {
	RegisterSchema(
		MessageID{Type: "ORDERS", Version: "D", Release: "99B", Agency: "UN"},
		ordersD99bSchema,
		"https://service.unece.org/trade/untdid/d99b/trmd/orders_c.htm",
	)
}

var ordersD99bSchema = Schema{Nodes: []SchemaNode{
