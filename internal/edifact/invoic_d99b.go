...
// INVOIC D.99B message specification: the structural (segment/group
...
// 53 segment groups, max nesting depth 3.
//
// Release note: this message type is also registered for D.20A
// (see invoic_d20a.go). D.99B was chosen as a second, older release
...
// http://web.archive.org/web/20220127000419/https://service.unece.org/trade/untdid/d99b/trmd/invoic_c.htm
...
// mechanically and verified the result balances (all 53 groups
// open and close consistently) before being transcribed here, rather than
// reading the ASCII nesting by eye.

func init() {
	RegisterSchema(
		MessageID{Type: "INVOIC", Version: "D", Release: "99B", Agency: "UN"},
		invoicD99bSchema,
		"https://service.unece.org/trade/untdid/d99b/trmd/invoic_c.htm",
	)
}

var invoicD99bSchema = Schema{Nodes: []SchemaNode{
	...
	{Segment: "GIS", Mandatory: false, MaxRepeat: 10}, // General indicator
