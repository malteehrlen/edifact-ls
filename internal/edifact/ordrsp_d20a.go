...
// ORDRSP D.20A message specification: the structural (segment/group
...
// http://web.archive.org/web/20240421122859/https://service.unece.org/trade/untdid/d20a/trmd/ordrsp_c.htm
...
func init() {
	RegisterSchema(
		MessageID{Type: "ORDRSP", Version: "D", Release: "20A", Agency: "UN"},
		ordrspD20aSchema,
		"https://service.unece.org/trade/untdid/d20a/trmd/ordrsp_c.htm",
	)
}

var ordrspD20aSchema = Schema{Nodes: []SchemaNode{
