...
// IFTMIN D.20A message specification: the structural (segment/group
// presence, order, cardinality) branching diagram for the Instruction Message
...
// 45 segment groups, max nesting depth 4.
//
// Source: https://service.unece.org/trade/untdid/d20a/trmd/iftmin_c.htm
// section 4.3.1 "Segment table". That URL currently returns HTTP 403 from
// Cloudflare when fetched directly; this data was transcribed from the
// Wayback Machine's archived copy instead:
// http://web.archive.org/web/20240423084948/https://service.unece.org/trade/untdid/d20a/trmd/iftmin_c.htm
...
// mechanically and verified the result balances (all 45 groups
// open and close consistently) before being transcribed here, rather than
// reading the ASCII nesting by eye.

func init() {
	RegisterSchema(
		MessageID{Type: "IFTMIN", Version: "D", Release: "20A", Agency: "UN"},
		iftminD20aSchema,
		"https://service.unece.org/trade/untdid/d20a/trmd/iftmin_c.htm",
	)
}

var iftminD20aSchema = Schema{Nodes: []SchemaNode{
