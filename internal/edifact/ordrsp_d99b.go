...
// ORDRSP D.99B message specification: the structural (segment/group
// presence, order, cardinality) branching diagram for the Purchase Order Response
...
// (see ordrsp_d20a.go). D.99B was chosen as a second, older release
...
// http://web.archive.org/web/20220127003807/https://service.unece.org/trade/untdid/d99b/trmd/ordrsp_c.htm
...
// mechanically and verified the result balances (all 56 groups
// open and close consistently) before being transcribed here, rather than
// reading the ASCII nesting by eye.

func init() {
	RegisterSchema(
		MessageID{Type: "ORDRSP", Version: "D", Release: "99B", Agency: "UN"},
		ordrspD99bSchema,
		"https://service.unece.org/trade/untdid/d99b/trmd/ordrsp_c.htm",
	)
}

var ordrspD99bSchema = Schema{Nodes: []SchemaNode{
	...
	{ // Segment group 9
		Group: []SchemaNode{
			{Segment: "PAT", Mandatory: true, MaxRepeat: 1},  // Payment terms basis
			{Segment: "DTM", Mandatory: false, MaxRepeat: 5}, // Date/time/period
	...
	{ // Segment group 26
		Group: []SchemaNode{
			...
			{Segment: "GIS", Mandatory: false, MaxRepeat: 99},   // General indicator
