...
// ORDERS D.20A message specification: the structural (segment/group
...
// 63 segment groups, max nesting depth 3.
//
// Source: https://service.unece.org/trade/untdid/d20a/trmd/orders_c.htm
// section 4.3.1 "Segment table". That URL currently returns HTTP 403 from
// Cloudflare when fetched directly; this data was transcribed from the
// Wayback Machine's archived copy instead:
// http://web.archive.org/web/20250915060518/https://service.unece.org/trade/untdid/d20a/trmd/orders_c.htm
...
// mechanically and verified the result balances (all 63 groups
...
var ordersD20aSchema = Schema{Nodes: []SchemaNode{
