...
// IFTDGN D.20A message specification: the structural (segment/group
// presence, order, cardinality) branching diagram for this message,
// UN/EDIFACT directory release D.20A. Scope is structural only -- not
// element-level content -- per edifact-ls-3uzr's epic non-goal.
// 15 segment groups, max nesting depth 4.
//
// Source: https://service.unece.org/trade/untdid/d20a/trmd/iftdgn_c.htm
// section 4.3.1 "Segment table". That URL currently returns HTTP 403 from
// Cloudflare when fetched directly; this data was transcribed from the
// Wayback Machine's archived copy instead:
// http://web.archive.org/web/20231201233051/https://service.unece.org/trade/untdid/d20a/trmd/iftdgn_c.htm
...
func init() {
	RegisterSchema(
		MessageID{Type: "IFTDGN", Version: "D", Release: "20A", Agency: "UN"},
		iftdgnD20aSchema,
		"https://service.unece.org/trade/untdid/d20a/trmd/iftdgn_c.htm",
	)
}

var iftdgnD20aSchema = Schema{Nodes: []SchemaNode{
	...
	{ // Segment group 7
		Group: []SchemaNode{
			...
			{Segment: "LOC", Mandatory: false, MaxRepeat: 4}, // Place/location identification
			{ // Segment group 8
				Group: []SchemaNode{
					{Segment: "TDT", Mandatory: true, MaxRepeat: 1},  // Transport information
					{Segment: "RFF", Mandatory: false, MaxRepeat: 9}, // Reference
				...
				Group: []SchemaNode{
					...
					{ // Segment group 14
						Group: []SchemaNode{
							...
							{Segment: "MEA", Mandatory: true, MaxRepeat: 9},   // Measurements
