...
// QUOTES D.20A message specification: the structural (segment/group
// presence, order, cardinality) branching diagram for this message,
// UN/EDIFACT directory release D.20A. Scope is structural only -- not
// element-level content -- per edifact-ls-3uzr's epic non-goal.
// 56 segment groups, max nesting depth 3.
//
// Source: https://service.unece.org/trade/untdid/d20a/trmd/quotes_c.htm
// section 4.3.1 "Segment table". That URL currently returns HTTP 403 from
// Cloudflare when fetched directly; this data was transcribed from the
// Wayback Machine's archived copy instead:
// http://web.archive.org/web/20231002220558/https://service.unece.org/trade/untdid/d20a/trmd/quotes_c.htm
...
// balances (all 56 groups open and close consistently)
...
func init() {
	RegisterSchema(
		MessageID{Type: "QUOTES", Version: "D", Release: "20A", Agency: "UN"},
		quotesD20aSchema,
		"https://service.unece.org/trade/untdid/d20a/trmd/quotes_c.htm",
	)
}

var quotesD20aSchema = Schema{Nodes: []SchemaNode{
	...
	{Segment: "IRQ", Mandatory: false, MaxRepeat: 10},  // Information required
	...
	{ // Segment group 9
		Group: []SchemaNode{
			...
			{Segment: "RNG", Mandatory: false, MaxRepeat: 2}, // Range details
		},
		Mandatory: false, MaxRepeat: 25,
	},
	{ // Segment group 10
		Group: []SchemaNode{
			{Segment: "DLM", Mandatory: true, MaxRepeat: 1},  // Delivery limitations
			{Segment: "MOA", Mandatory: false, MaxRepeat: 1}, // Monetary amount
			{Segment: "DTM", Mandatory: false, MaxRepeat: 1}, // Date/time/period
		},
		Mandatory: false, MaxRepeat: 1,
	...
	{ // Segment group 27
		Group: []SchemaNode{
			...
			{Segment: "PGI", Mandatory: false, MaxRepeat: 1},    // Product group information
			{ // Segment group 28
				Group: []SchemaNode{
			...
			{ // Segment group 31
				Group: []SchemaNode{
					...
					{Segment: "RNG", Mandatory: false, MaxRepeat: 1}, // Range details
					{Segment: "CUX", Mandatory: false, MaxRepeat: 5}, // Currencies
					{Segment: "DTM", Mandatory: false, MaxRepeat: 5}, // Date/time/period
				},
				Mandatory: false, MaxRepeat: 99,
			},
