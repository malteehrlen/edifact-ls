...
// JOBMOD D.20A message specification: the structural (segment/group
// presence, order, cardinality) branching diagram for this message,
// UN/EDIFACT directory release D.20A. Scope is structural only -- not
// element-level content -- per edifact-ls-3uzr's epic non-goal.
// 19 segment groups, max nesting depth 3.
//
// Source: https://service.unece.org/trade/untdid/d20a/trmd/jobmod_c.htm
// section 4.3.1 "Segment table". That URL currently returns HTTP 403 from
// Cloudflare when fetched directly; this data was transcribed from the
// Wayback Machine's archived copy instead:
// http://web.archive.org/web/20231207014152/https://service.unece.org/trade/untdid/d20a/trmd/jobmod_c.htm
...
func init() {
	RegisterSchema(
		MessageID{Type: "JOBMOD", Version: "D", Release: "20A", Agency: "UN"},
		jobmodD20aSchema,
		"https://service.unece.org/trade/untdid/d20a/trmd/jobmod_c.htm",
	)
}

var jobmodD20aSchema = Schema{Nodes: []SchemaNode{
